...
public class Mover extends Command {
   ...
   * Directory with the same name as OLDPATH in NEWPATH if one exists, as long
   * as OLDPATH is not a parent of NEWPATH
   * 
  ...
  /*
   * This method will overwrite the text of NEWPATH with that of OLDPATH, then
   * deletes OLDPATH
   * 
   * @param oldpath The Directory which corresponds to the given OLDPATH
   * @param newpath The Directory which corresponds to the given NEWPATH
   ...
   * File using its path String representation. Necessary for deleting a File
   * 
