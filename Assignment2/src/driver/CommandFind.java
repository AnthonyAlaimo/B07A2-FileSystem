...
public class CommandFind extends Command {
  ...
  private static final String documentation =
      (" Description:\n--------------------------------------------\n\t"
          ...
          + "Where OUTFILE is the name of FILE.\n\t\t> is for overwritting"
          + " OUTFILE and >> is for Appending into OUTFILE.\n\n Possible Exc"
          + "eptions:\n--------------------------------------------\n\tinval"
          + "idPathException, invalidSyntaxException, invalidNameException");
  ...
  private Object getType(String typeInStr) {
    ...
    if (typeInStr.equals("f")) {
      ...
      ExceptionHandler.invalidSyntaxException("find");
    }
  ...
  /**
   * Helper method for runCommand that strips the surrounding quotations and accepts string as a
  ...
  public String runCommand(String input) {
    ...
    if (Validator.validateFind(inputList)) {
  ...
  public String printDocumentation() {
    ...
    return CommandFind.documentation;
  }
  ...
  private void updateSearchFormat(String name, Object type) {
    ...
    CommandFind.search = (name + " of type " + typeStr + " found in path(s):"
        + "\n--------------------------------------------\n");
  }
